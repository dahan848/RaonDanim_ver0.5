...
public class AccountsService {
   ...
   private AccountsUserDAO dao;
	...
	@Autowired
	private WithReviewBoardDao testDao;
...
//      System.out.println("isEmpty  "+userData.isEmpty());
...
//      }
   ...
   public Map<String, Object> getProfileData(int usernum){
      ...
      //후기 평점 
		double reviewAvg = 0;
		if(!testDao.avgStarNullCheck(usernum).isEmpty()) {
			reviewAvg = Math.round(testDao.avgStar(usernum)*10)/10.0;
		}
      ...
      result.put("with_avg", reviewAvg);            //후기 평점
